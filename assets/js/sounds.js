...
(function () {
    ...
    const NAV_BACK_SELECTORS = [
        ...
        '#nav2 > ul > li > a',
        '.game-card',
        '.hl-mini',          // slide mini game tiles
        'a.hl-slide-bg',     // slide game cards (generated by slider script)
        '.banner-zoom',                          
    ...
    document.addEventListener('click', function (e) {
        ...
        const trigger = e.target.closest('.game-card, .back-to-home, [data-back-home], .banner-zoom, .hl-btn, .hl-mini, a.hl-slide-bg');
        if (!trigger) return;
